...
module.exports = {
    ...
    Harvester_03: ({ genMode: "Config", partsSet: [[WORK, 4], [MOVE, 4], [CARRY, 4]], spawnName: "NewLand", roomName: "E9S21" }),
    Harvester_04: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Harvester_05: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Harvester_06: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    ...
    Upgrader_03: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Upgrader_04: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Upgrader_05: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Upgrader_06: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Upgrader_07: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Upgrader_08: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Upgrader_09: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    Upgrader_10: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),

    /**
     *   Builder模板文件
     */
    Builder_01: ({ genMode: "Config", partsSet: [[WORK, 5], [MOVE, 15], [CARRY, 10]], spawnName: "Home", roomName: "E6S22" }),
    Builder_02: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 3], [CARRY, 3]], spawnName: "NewLand", roomName: "E9S21" }),
    ...
    OuterBuilder_2: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 16], [CARRY, 10]], spawnName: "Home", roomName: "E6S22" }),
    ...
    Miner_01: ({ genMode: "Config", partsSet: [[WORK, 6], [MOVE, 6], [CARRY, 6]], spawnName: "Home", roomName: "E6S22" }),
}